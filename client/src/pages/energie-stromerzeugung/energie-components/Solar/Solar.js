...
<Row className="YellowRow">
  ...
  <div className="TextLeft">
   ...
   <Col>
   <img className="ImgRight" src={strahlen}/>
   </Col>
</Row>
<h4 className='H4'>Photovoltaik</h4>
<Row className="WhiteRow">
  <img className="ExtraImg" src={silizium}/>
...
<Row className="ExtraRow">
  ...
  <Col>
   ...
   <img className="ExtraImgRight" src={solarzelle2} />
   </Col>
</Row>
