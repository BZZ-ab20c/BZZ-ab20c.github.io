   ...
   return(
      <div>
         ...
         elektrischen Strom erzeugen. Jeder Block enthält einen Kernreaktor.
            ...
            <Col>
            <img className="ImgRight" src={reaktor}/>
            </Col>
         </Row>
         <h4 className='H4'>Leichtwasserreaktor</h4>
         <Row className="WhiteRow">
         <Col>
               <img className="ImgLeft" src={leichtwasserreaktor}/>
         </Col>
         <Col>
         ...
         <Row className="GrayRow">
            ...
            <Col>
            <img className="GifRight" src={druckwasserreaktor}/>
            </Col>
         </Row>
         <h4 className='H4'>Sidewasserreaktor</h4>
         <Row className="WhiteRow">
         <Col>
            <img className="GifLeft" src={sidewasserreaktor}/>
         </Col>
         <Col>
            <div className="TextRight">
         ...
         <Col>
            ...
            <Col>
            <img className="ImgRight" src={nasskuehlturm}/>
            </Col>
         </Row>
         <h4 className='H4'>Hybrid-Kühltürme</h4>
         <Row className="WhiteRow">
         <img className="ExtraImg" src={hybridkuehlturm}/>
         ...
         <Row className="GrayRow">
         <Col>
            <img className="ImgLeft" src={daumenRunter}/>
            </Col>
            <Col>
            <div className="TextRight">
                  <li>
         ...
         <div className="TextLeft">   
            ...
            <Col>
            <img className="ImgRight" src={daumenHoch}/>
            </Col>
         </Row>
         </Container>
      </div>
