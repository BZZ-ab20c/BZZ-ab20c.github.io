...
<Row className="BlueRow">
  ...
  <div className="TextLeft">
   ...
   <Col>
   <img className="ImgRight" src={niederdruckwerk} />
   </Col>
</Row>
<h4 className='H4'>Mitteldruckkraftwerk</h4>
<Row className="WhiteRow">
  <Col>
  <img className="ImgLeft" src={mitteldruckwerk} />
  </Col>
  <Col>
...
<Row className="BlueRow">
  ...
  <div className="TextLeft">
   ...
   <Col>
   <img className="ImgRight" src={hochdruckwerk} />
   </Col>
</Row>
<h4 className='H4'>Funktionsweise</h4>
<Row className="ExtraRow">
  <Col>
  <img className="ImgLeft" src={funktionsweise1} />
  ...
  <Col>
   ...
   <img className="ExtraImgRight" src={funktionsweise2} />
   </Col>
</Row>
